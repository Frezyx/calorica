            ...
            child:
              Container(
                ...
                top:MediaQuery.of(context).size.height/6, 
                  ...
                  child:  isFP?  getFP() : isSP? getSP(): getTP(),
            ),
          ),
        ),
      ),
                        ...
                        callback: () {
                          if(_formKey.currentState.validate()){
                            if(_weight != null && _height != null){
                              DBUserProvider.db.updateDateProducts("weight", _weight).then((count1){
                                DBUserProvider.db.updateDateProducts("height", _height).then((count2){
                      ...
                      GradientButton(
                        ...
                        callback: () {
                          if(_formKey2.currentState.validate()){
                            if(_age != null){
                               DBUserProvider.db.updateDateProducts("gender", _gender).then((count1){
                                DBUserProvider.db.updateDateProducts("age", _age).then((count2){
                                  if(count1 == 1 && count2 == 1){
                                    setState(() {
                                      isSP = false;
                                    });
