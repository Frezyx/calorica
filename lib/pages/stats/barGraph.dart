...
getBarGraph(context, _seriesData, caloryLimitDeltaL, caloryLimitDeltaR, todayParams, yesterdayParams){
  ...
  generateData(yesterdayParams, todayParams, caloryLimitDeltaR , caloryLimitDeltaL ) {
              ...
              charts.Series(
                ...
                fillColorFn: (GraphData data, _) =>
                    charts.ColorUtil.fromDartColor(
                        (todayParams.calory < yesterdayParams.calory || todayParams.calory <= caloryLimitDeltaR && todayParams.calory >= caloryLimitDeltaL )?
                         DesignTheme.secondChartsGreen : DesignTheme.secondChartRed
                      ),
              ),
              charts.Series(
                domainFn: (GraphData data, _) => data.place,
                ...
                fillColorFn: (GraphData data, _) =>
                    charts.ColorUtil.fromDartColor(
                        (todayParams.calory < yesterdayParams.calory || todayParams.calory <= caloryLimitDeltaR && todayParams.calory >= caloryLimitDeltaL )? DesignTheme.secondColor : DesignTheme.redColor
                      ),
              ), 
            ];
  }
